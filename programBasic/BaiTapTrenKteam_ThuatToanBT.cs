...
{
    class BaiTapTrenKteam_ThuatToanBT
    {
        #region các phương thức hỗ trợ cho các bài tập 
        /// <summary>
        ...
        public void exercise2()
        {
            ...
            Console.Write(" nhập vào một chuổi bất kỳ :");
            String any = Console.ReadLine();
            Console.WriteLine("chuổi mới nhập là : ", any);
        }
        /// <summary>
        ...
        public void exercise3()
        {
            ...
            Console.WriteLine(" số a : {0} số b : {1} số c : {2} ", a, b, c);
        }
        /// <summary>
        ...
        public void exercise4and6()
        {
            ...
            Console.WriteLine(a);
            Console.WriteLine(b);
            Console.WriteLine(String.Format("Value1 = {0} | Value2 = {1}", a, b));
        ...
        public void exercice12()
        {
            ...
            a = testIntInPut(ip1); b = testIntInPut(ip2);
            if (a == 0)
            {
        ...
        public void exercice13()
        {
            ...
            a = testIntInPut(ip1); b = testIntInPut(ip2); c = testIntInPut(ip3);
            denta = b * 1.0 * b - 4 * a * c;
            if (a == 0)
            {
        ...
        public void exercice15()
        {
            ...
            ip3 = Console.ReadLine();
        nhaplai:
            int day = testIntInPut(ip1);
            int month = testIntInPut(ip2);
            int years = testIntInPut(ip3);
            if (day <= 31 && month <= 12)
            {
        ...
        public void exercice29()
        {
            ...
            string ip = Console.ReadLine();
            int mom = testIntInPut(ip);
            Console.Write("\n nhap so con : ");
            string ip2 = Console.ReadLine();
            int son = testIntInPut(ip2);
            if (mom == son)
            {
            ...
            {
                int[] A = numberseparation(mom, son);
                int count = countN(mom);
                int i = 0;
                while (count > i)
                {
                    if (A[i] == son)
        ...
        public void exercice32()
        {
            ...
            int n = testIntInPut(ip);
            int[] A = tachso(n);
            int[] op = timSoChiaHetCho3(A, n);
            int number = counttimSoChiaHetCho3(A, n);
            int i = 0;
    ...
    public class runForBaiTapTrenKteam_ThuatToanBT
    {
        public void runForThisClass()
        {
            BaiTapTrenKteam_ThuatToanBT cls = new BaiTapTrenKteam_ThuatToanBT();
            cls.countN(45);
        }
    }
}