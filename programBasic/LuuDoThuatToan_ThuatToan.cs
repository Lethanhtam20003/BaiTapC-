...
namespace programBasic
{
    ...
    /// sum
    /// </summary>
    public class LuuDoThuatToan_ThuatToan
    {
        /// <summary>
    ...
    public class runForcacpheptinh_baiToanCoGiaoDienConsole
    {
        ...
        dangbai:
            ...
            baitoanso:
                ...
                programBasic.baiToanCoGiaoDienConsole_ToanSo cls = new programBasic.baiToanCoGiaoDienConsole_ToanSo();
            ...
            baitoanhinh:
                ...
                Console.WriteLine("");
                programBasic.baiToanCoGiaoDienConsole_ToanHinh cls = new programBasic.baiToanCoGiaoDienConsole_ToanHinh();
    ...
    public class runForLuaDoThuatToan
        ...
        baitoan:
            ...
            LuuDoThuatToan_ThuatToan cls = new LuuDoThuatToan_ThuatToan();// Declare instant of class
            if (baitoan.Equals("1"))
            {
                cls.TinhSumN();
                goto baitoan;
